      ...
      <div className="container mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2 mb-2">
                  <span className="text-4xl font-bold text-pink-600">{stats.averageRating.toFixed(1)}</span>
                  <div className="flex">{renderStars(Math.round(stats.averageRating))}</div>
                </div>
              </div>
              <div className="text-center">
                <p className="text-gray-600 text-sm mb-2">Total Reviews</p>
                <p className="text-4xl font-bold text-purple-600">{stats.totalReviews}</p>
              </div>
              <div className="text-center">
                <p className="text-gray-600 text-sm mb-2">5-Star Reviews</p>
                <p className="text-4xl font-bold text-yellow-600">{stats.ratingDistribution[5]}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {reviews.length === 0 ? (
          ...
          <div className="space-y-4">
            {reviews.map((review) => (
              <div key={review.id} className="bg-white rounded-xl shadow-lg p-6 border-2 border-gray-100 hover:border-pink-200 transition-all">
