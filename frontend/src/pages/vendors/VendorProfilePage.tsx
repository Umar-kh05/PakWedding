...
export default function VendorProfilePage() {
  const { id } = useParams()
  const [vendor, setVendor] = useState<UiVendor | null>(null)
        ...
        setVendor({
          ...
          packages: [
            ...
            },
            {
              name: 'Standard',
              price: 'Rs. 100,000',
              features: ['Full day coverage', '2 photographers', 'Drone shots'],
            },
            {
              name: 'Premium',
              price: 'Rs. 200,000',
              features: ['Full studio team', 'Same day edit', 'Photo album'],
            },
          ],
        })
      } catch {
        // If API fails, keep vendor null; we could add a simple fallback later
      }
    }
    load()
  }, [id])
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-12">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex items-center gap-4 mb-4 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg text-gray-600">
                    {uiVendor.rating} ({uiVendor.reviews} reviews)
                  </span>
                </div>
            ...
            <div className="flex flex-col items-end gap-3">
              <Link
                to={`/bookings/new?vendor=${vendor._id}`}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {uiVendor.packages.map((pkg, index) => (
              <div
                key={index}
              ...
              >
                ...
                <Link
                  to={`/bookings/new?vendor=${vendor._id}&package=${pkg.name}`}
